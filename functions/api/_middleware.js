...
const RULES = [
  ...
  { prefix: "/api/sales", roles: ["admin", "accountant"] },
  ...
  { prefix: "/api/change-my-pin", roles: ["admin", "accountant", "worker", "dispatch", "reseller"] },
  ...
  { prefix: "/api/reseller-redeem-cash", roles: ["admin", "accountant", "reseller"] },
